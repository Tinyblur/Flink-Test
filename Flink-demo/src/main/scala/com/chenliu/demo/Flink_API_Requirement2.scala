...
object Flink_API_Requirement2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val wmDS: DataStream[Sensor] = mapDS.assignTimestampsAndWatermarks(
      new AssignerWithPunctuatedWatermarks[Sensor] {override def checkAndGetNextWatermark(lastElement: Sensor, extractedTimestamp: Long): Watermark = {
